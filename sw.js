const CACHE='dark-timeline-project-v10-review';
const ASSETS=['./','./index.html','./app.js','./style.css','./v10_patch.css','./v10_patch.js','./manifest.webmanifest','./icon.svg','./icon-192.png','./icon-512.png'];
