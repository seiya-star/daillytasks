const CACHE='dark-timeline-project-v9-no-rokuyo';
const ASSETS=['./','./index.html','./app.js','./style.css','./hide_rokuyo.css','./manifest.webmanifest','./icon.svg','./icon-192.png','./icon-512.png'];
